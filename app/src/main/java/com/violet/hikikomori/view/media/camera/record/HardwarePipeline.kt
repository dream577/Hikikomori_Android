...
import com.violet.hikikomori.view.media.camera.util.AutoFitSurfaceView
...
class HardwarePipeline(
    ...
    private class RenderHandler(
        ...
        private fun copyRenderToPreview() {
            ...
            copyTexture(
                renderTexId, renderTexture, Rect(
        ...
        private fun copyRenderToEncode() {
            ...
            copyTexture(
                renderTexId, renderTexture, Rect(0, 0, viewportWidth, viewportHeight),
                passthroughShaderProgram!!
            )
