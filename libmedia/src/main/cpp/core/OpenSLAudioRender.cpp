...
OpenSLAudioRender::OpenSLAudioRender(AVRenderCallback *callback) {
...
void OpenSLAudioRender::_EnqueueAudioFrame() {
    shared_ptr<AVMediaFrame> frame = m_Callback->GetOneFrame(AVMEDIA_TYPE_AUDIO);
    if (frame && !stop) {
...
void OpenSLAudioRender::StartLoop() {
