...
private:
    ...
    AVTransformMatrix m_transformMatrix;
    mat4 m_MVPMatrix;

    void _DrawGRBA(AVMediaFrame *frame);

    void _DrawI420(AVMediaFrame *frame);

    void _DrawNV12orNV21(AVMediaFrame *frame);

public:
    void OnDrawFrame(AVMediaFrame *frame);
