...
void ImageGLRender::OnDrawFrame(AVMediaFrame *frame) {
...
void ImageGLRender::_DrawGRBA(AVMediaFrame *frame) {
...
void ImageGLRender::_DrawI420(AVMediaFrame *frame) {
    //upload Y plane data
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, m_TextureId[0]);
...
void ImageGLRender::_DrawNV12orNV21(AVMediaFrame *frame) {
    // update Y plane data
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, m_TextureId[0]);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_LUMINANCE, frame->width,
