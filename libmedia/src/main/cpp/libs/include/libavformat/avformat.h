...
#define AVFMT_FLAG_FLUSH_PACKETS    0x0200 ///< FlushDecoder the AVIOContext every packet.
/**
...
#define AVFMT_FLAG_SHORTEST   0x100000 ///< StopDecoder muxing when the shortest stream stops.
...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
    ...
    /**
     * FlushDecoder the I/O context after each packet.
     * - encoding: Set by user
     * - decoding: unused
     */
    int flush_packets;
