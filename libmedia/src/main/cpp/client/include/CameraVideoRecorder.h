...
class CameraVideoRecorder : public AVSurface, public AVRenderCallback, public EncoderCallback {
...
private:
    ...
    shared_ptr<LinkedBlockingQueue<AVMediaFrame>> m_VideoRenderQueue;
...
public:
    ...
    shared_ptr<AVMediaFrame> GetOneFrame(int type) override;
