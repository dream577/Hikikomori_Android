#ifndef HIKIKOMORI_LOGUTIL_H
#define HIKIKOMORI_LOGUTIL_H

#include <android/log.h>
#include <sys/time.h>

#define  LOG_TAG "MEDIA_PLAYER"
...
#define DEBUG_LOGCATE(...) LOGCATE("[Time:%ld][File:%s, Fun:%s, Line:%d][Message:%s]",(long)GetSysCurrentTime(), __FILE_NAME__, __FUNCTION__, __LINE__, __VA_ARGS__)

#endif //HIKIKOMORI_LOGUTIL_H
